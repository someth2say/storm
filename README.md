...
./mvnw package
```
It produces the `flare-1.0.0-SNAPSHOT-runner.jar` file in the `/target` directory.
...
The application is now runnable using `java -jar target/flare-1.0.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./target/flare-1.0.0-SNAPSHOT-runner`
